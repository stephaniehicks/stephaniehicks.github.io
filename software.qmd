...
- [R/SpatialArtifacts](https://bioconductor.org/packages/SpatialArtifacts) \| <img src="https://bioconductor.org/shields/years-in-bioc/SpatialArtifacts.svg"/> \| R/Bioconductor package to identify tissue artifacts (such as dry edge effects) based on morphological image processing methods. ([He et al., 2026. *bioRxiv*](https://doi.org/10.64898/2026.05.15.725260))
- [R/BatchSVG](https://bioconductor.org/packages/BatchSVG) \| <img src="https://bioconductor.org/shields/years-in-bioc/BatchSVG.svg"/> \| R/Bioconductor package to identify features (such as spatially variable genes) that are associated with a covariate, such as a batch effect. ([Shah and Hou et al., 2026. *Bioinformatics*](https://doi.org/10.1093/bioinformatics/btag522))
- [R/HuBMAPR](https://bioconductor.org/packages/HuBMAPR) \| <img src="https://bioconductor.org/shields/years-in-bioc/HuBMAPR.svg"/> \| R/Bioconductor package that serves as an R Client for the HuBMAP Data Portal. ([Hou et al., 2025. *Bioinformatics Advances*](https://doi.org/10.1093/bioadv/vbaf048))
- [R/spoon](https://bioconductor.org/packages/spoon) \| <img src="https://bioconductor.org/shields/years-in-bioc/spoon.svg"/> \| R/Bioconductor package that addresses the mean-variance relationship in spatially resolved transcriptomics data. ([Shah et al., 2025. *Biostatistics*](https://doi.org/10.1093/biostatistics/kxaf012)).
...
- [humanHippocampus2024](https://www.bioconductor.org/packages/humanHippocampus2024) \| Access spatially-resolved transcriptomics and single-nucleus RNA sequencing data from adjacent tissue sections of the anterior human hippocampus across ten adult neurotypical donors from [Thompson, Nelson, Tippani et al. (2025). *Nature Neuroscience*](https://doi.org/10.1038/s41593-025-02022-0).
...
- [Orchestrating Spatial Transcriptomics Analysis with Bioconductor](https://bioconductor.org/books/release/OSTA) (OSTA). ([Crowell and Dong et al., 2025. *bioRxiv*](https://doi.org/10.1101/2025.11.20.688607))
- [Orchestrating Single-Cell Analysis in Bioconductor](http://bioconductor.org/books/release/OSCA) ([Amezquita et al., 2020. *Nature Methods*](https://doi.org/10.1038/s41592-019-0654-x))
...
- [PyPI/spatial-artifacts](https://pypi.org/project/spatial-artifacts) ![PyPI - Version](https://img.shields.io/pypi/v/spatial-artifacts) \| A package to identify tissue artifacts (such as dry edge effects) based on morphological image processing methods.([He et al., 2026. *bioRxiv*](https://doi.org/10.64898/2026.05.15.725260)).
- [PyPI/spotsweeper](https://pypi.org/project/spotsweeper) ![PyPI - Version](https://img.shields.io/pypi/v/spotsweeper) \| Python implementation of functions that provides spatially-aware quality control metrics for spatial transcriptomics data. ([Chen et al., 2026. *F1000*](https://f1000research.com/articles/15-33/v1)).
...
- [R/spaTransfer](https://github.com/cindyfang70/spaTransfer) \| Spatially aware unsupervised clustering for spatial omics data. ([Fang et al.(2025). *bioRxiv*](https://doi.org/10.64898/2025.12.12.694021)).
- [R/spatialMNN](https://github.com/Pixel-Dream/spatialMNN) \| Spatially aware unsupervised clustering for spatial omics data. ([Zhou et al.(2025). *Bioinformatics*](https://doi.org/10.1093/bioinformatics/btaf403)).
