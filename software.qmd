...
- [R/escheR](https://bioconductor.org/packages/escheR) | <img src="https://bioconductor.org/shields/years-in-bioc/escheR.svg"> |  Built off of ggplot2 and the Gestalt principles to visualize multi-dimensional data in the 2D space (e.g. embedding or spatial visualizations). ([Guo and Hicks, 2023. _bioRxiv_](https://doi.org/10.1101/2023.03.18.533302)).
- [R/TREG](https://www.bioconductor.org/packages/TREG) | <img src="https://bioconductor.org/shields/years-in-bioc/TREG.svg"> | R/Bioconductor package to find Total RNA Expression Genes (TREGs) in single nucleus RNA-seq data ([Huuki-Myers et al., 2022. _bioRxiv_](https://doi.org/10.1101/2022.04.28.489923)).
- [R/nnSVG](https://www.bioconductor.org/packages/nnSVG) | <img src="https://bioconductor.org/shields/years-in-bioc/nnSVG.svg"> | R/Bioconductor package that provides a scalable method to identify spatially variable genes (SVGs) in spatially-resolved transcriptomics data based on nearest-neighbor Gaussian processes. ([Weber et al., 2022. _Nature Communications_](https://www.biorxiv.org/content/10.1101/2022.05.16.492124v1)).
...
- [Python/samui](https://github.com/chaichontat/samui) | A performant web-based interactive visualization tool for spatially-resolved transcriptomics experiments called [Samui Browser](https://samuibrowser.com). ([Sriworarat et al., 2023. _bioRxiv_](https://doi.org/10.1101/2023.01.28.525943))
