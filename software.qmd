...
- [R/SpatialArtifacts](https://bioconductor.org/packages/SpatialArtifacts) \| <img src="https://bioconductor.org/shields/years-in-bioc/SpatialArtifacts.svg"/> \| R/Bioconductor package to identify tissue artifacts (such as dry edge effects) based on morphological image processing methods.
...
-   [PyPI/spotsweeper](https://pypi.org/project/spotsweeper) ![PyPI - Version](https://img.shields.io/pypi/v/spotsweeper) \| Python implementation of functions that provides spatially-aware quality control metrics for spatial transcriptomics data. ([Chen et al., 2025. *bioRxiv*](https://doi.org/10.1186/s13059-015-0679-0)).
