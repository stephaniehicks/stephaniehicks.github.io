...
```{=html}
<p style="text-align:center;"><img src="polietly-say-no.jpg" width="600" height="500" alt="Logo"></p>
```
...
```{=html}
<img style="float: center; margin:0px 20px" src="faculty-flowchart.png" width="900" height="412" />
```
