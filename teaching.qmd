...
-   [Orchestrating Spatial Transcriptomics Analysis with Bioconductor](https://bioconductor.org/books/release/OSTA/) (OSTA). Online book that provides reproducible examples and discussion on computational analysis workflows for spatial omics data using Bioconductor in R. Online companion for a [manuscript](https://doi.org/10.1101/2025.11.20.688607) available as a preprint in *bioRxiv*.
...
-   2025 \| **Instructor**, [Statistical Programming Paradigms and Workflows](https://stephaniehicks.com/jhustatprogramming2025) (PH.140.777)
